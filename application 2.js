$('document').ready(function(){
  ...
  // singleapp------------------------------------------------------------------
    $('#select_frame_wrapper').append('\
        ...
        $( "#container_1>#template_1" ).load( "templates/singleapp.html .singleapp",function(data){
            ...
            $( "#select_frame_wrapper #select_single_1" ).addClass('text')
        ...
        $( "#container_1>#template_2" ).load( "templates/singleapp.html .singleapp",function(data){
            ...
            $( "#select_frame_wrapper #select_single_2" ).addClass('utility')
        ...
        $( "#container_1>#template_3" ).load( "templates/singleapp.html .singleapp",function(data){
            ...
            $( "#select_frame_wrapper #select_single_3" ).addClass('text display_1')
        ...
        $( "#container_1>#template_4" ).load( "templates/singleapp.html .singleapp",function(data){
            ...
            $( "#select_frame_wrapper #select_single_4" ).addClass('display_1 display_2')
        ...
        $( "#container_1>#template_5" ).load( "templates/singleapp.html .singleapp",function(data){
            ...
            $( "#select_frame_wrapper #select_single_5" ).addClass('text display_1 display_2')
        ...
        $( "#container_1>#template_6" ).load( "templates/singleapp.html .singleapp",function(data){
            ...
            $( "#select_frame_wrapper  #select_single_6" ).addClass('utility')
        ...
        $( "#container_1>#template_7" ).load( "templates/singleapp.html .singleapp",function(data){
            ...
            $( "#select_frame_wrapper  #select_single_7" ).addClass('display_3 display_6 display_4 display_5')
  ...
  // // ----------------------------------------------------------------------------
        ...
        $( "#select_frame_wrapper #select_layout_pattern_1" ).addClass('text')
        ...
        $( "#select_frame_wrapper #select_layout_pattern_2" ).addClass('display_1 display_2 display_3 display_6 display_4 display_5')
        ...
        $( "#select_frame_wrapper #select_layout_pattern_3" ).addClass('display_1 display_2 display_3 display_6 display_4 display_5')
  // -------------------------------------------------------------------------------
        $( "#select_frame_wrapper").append('\
        ...
        $( "#select_frame_wrapper #select_layout_device_1" ).addClass('text')
        ...
        $( "#select_frame_wrapper #select_layout_device_2" ).addClass('display_1 display_2 display_3 display_6 display_4 display_5')
        ...
        $( "#select_frame_wrapper #select_layout_device_3" ).addClass('display_1 display_2 display_3 display_6 display_4 display_5')
  // -------------------------------------------------------------------------------
        $( "#container_4" ).load( "templates/reply_components.html .reply_components")
  // -------------------------------------------------------------------------------
        $( "#select_frame_wrapper").append('<span id="select_layout_desktop_frame">\
        ...
        $( "#select_frame_wrapper #select_layout_desktop_1" ).addClass('text')
        ...
        $( "#select_frame_wrapper #select_layout_desktop_2" ).addClass('display_1 display_2 display_3 display_6 display_4 display_5')
        ...
        $( "#select_frame_wrapper #select_layout_desktop_3" ).addClass('display_1 display_2 display_3 display_6 display_4 display_5')
  // -------------------------------------------------------------------------------
