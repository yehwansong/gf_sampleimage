...
var table_array = [['Scale Category', 'Typeface', 'Font', 'Size', 'Case', 'Letter spacing'],
  ...
  function insert_sketch_4(){
    $('#sketch_frame').append(`\
      <div id="sketch_4" class="sketch">\
            <div id="loading">\
              <div class="loadingbar">\
                <div class="loadingindicator"></div>\
              </div>\
              <div class="h6 loadingtext">Loading application</div>\
            </div>\
          <div class="loading_wrapper hide fadedown">\
            <div class="img img_1"></div>\
            <div class="overline" contenteditable="true"><div id="icon"></div>LMBRJK</div>\
                <div class="h6" contenteditable="true">$400</div>\
            <div class="h5" contenteditable="true">Flow Shirt Blouse</div>\
  ...
  function add_selected(){
      if($('.sketch').length > 3){
          ...
          console.log('#sketch_'+ Math.floor(Math.random() * 4) + 1)
          if(ran == 4){
             loading_loop()
           }
      }else{
